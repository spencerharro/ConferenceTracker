...
namespace ConferenceTracker
{
    ...
    public partial class I2RloginEntities3 : DbContext
    {
        public I2RloginEntities3()
            : base("name=I2RloginEntities3")
        {
        }
        ...
        public virtual DbSet<InvitedAttendee> InvitedAttendees { get; set; }
