<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="North.aspx.cs" Inherits="ConferenceTracker.North" %>
        ...
        <div <%--style="background-color:#DB3C0F"--%>>
            ...
            <div id="lower">
                ...
                <div class="attendeeZone">
                    <div>
                        <p class="descriptionText"><strong>Attendees In North Conference Room:</strong></p>
